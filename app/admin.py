...
from . models import Product, Customer, Cart, Payment, OrderPlaced, Payapp, Paywhatsapp
...
class PayappModelAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'name', 'contact', 'address', 'city', 'state', 'email', 'receipt', 'amount', 'paid','payment_time' ]

@admin.register(Paywhatsapp)   
class PaywhatsappModelAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'name', 'contact', 'address', 'city', 'state', 'email',  'amount', 'paid','payment_time' ]